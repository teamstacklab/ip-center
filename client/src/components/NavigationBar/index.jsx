...
import { LojasRoute, MinhasLojasRoute } from "../../pages/Lojas";
  ...
  return (
    <React.Fragment>
      <header className="top-bars position-fixed w-100">
        ...
        <NavBar className="nav-bar w-100 m-0 py-0" expand="lg">
          <div className="nav-bar-container m-0 p-0 px-3 align-items-center w-100">
            ...
            <NavBar.Toggle className="ms-auto menu__button border-0 px-2 py-2" aria-controls="menuList" />
          </div>
